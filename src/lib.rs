...
//! reason ([`Suite::opt_out`]), and the opt-out list is part of the report. A
//! module that serves its own vocabulary registers the namespace
//! ([`Suite::namespace`]).
//!
...
pub use report::{Declarations, Finding, OptedOut, Report};
